...
public class EventService {
    ...
    public void add(@Valid EventDto dto){
        ...
        if (!schoolService.isSchoolOpened(tenant.getName(), LocalDateTime.of(dto.getEventDate(), dto.getBegin())) ||
                !schoolService.isSchoolOpened(tenant.getName(), LocalDateTime.of(dto.getEventDate(), dto.getEnd()))){
